...
QString TransactionDesc::toHTML(CWallet *wallet, CWalletTx &wtx,
    ...
    if (wtx.IsCoinBase() && nCredit == 0) {
        ...
        if (wtx.IsInMainChain())
            strHTML += BtcnanoUnits::formatHtmlWithUnit(unit, nUnmatured) +
        ...
        //
        strHTML += "<b>" + tr("Credit") + ":</b> " +
                   BtcnanoUnits::formatHtmlWithUnit(unit, nNet) + "<br>";
    } else {
        ...
        if (fAllFromMe) {
            ...
            for (const CTxOut &txout : wtx.tx->vout) {
                ...
                strHTML += "<b>" + tr("Debit") + ":</b> " +
                           BtcnanoUnits::formatHtmlWithUnit(
            ...
            if (fAllToMe) {
                ...
                strHTML += "<b>" + tr("Total debit") + ":</b> " +
                           BtcnanoUnits::formatHtmlWithUnit(unit, -nValue) +
                           "<br>";
    ...
    strHTML += "<b>" + tr("Net amount") + ":</b> " +
               BtcnanoUnits::formatHtmlWithUnit(unit, nNet, true) + "<br>";
