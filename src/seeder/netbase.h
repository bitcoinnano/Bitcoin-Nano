// Copyright (c) 2009-2012 The Btcnano developers
// Distributed under the MIT/X11 software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.
#ifndef BTCNANO_SEEDER_NETBASE_H
#define BTCNANO_SEEDER_NETBASE_H
...
public:
    ...
    bool IsRFC1918() const;  // IPv4 private networks (10.0.0.0/8,
...
bool Lookup(const char *pszName, std::vector<CService> &vAddr,
