...
#ifndef BTCNANO_QT_RECEIVECOINSDIALOG_H
#define BTCNANO_QT_RECEIVECOINSDIALOG_H
...
/** Dialog for requesting payment of btcnanos */
...
#endif // BTCNANO_QT_RECEIVECOINSDIALOG_H
