...
public:
	...
	consensus.nSubsidyHalvingInterval = 210000;
		...
		pchNanoMessageStart[1] = 0xf9;
        pchNanoMessageStart[1] = 0xbe;
        pchNanoMessageStart[2] = 0xb4;
        pchNanoMessageStart[3] = 0xd9;						
...
public:
    CTestNetParams() {
        ...
        pchNanoMessageStart[0] = 0x0b;
        pchNanoMessageStart[1] = 0x11;
        pchNanoMessageStart[2] = 0x09;
        pchNanoMessageStart[3] = 0x07;
        nDefaultPort = 19556;
...
public:
    CRegTestParams() {
        ...
        pchNanoMessageStart[0] = 0xfa;
        pchNanoMessageStart[1] = 0xbf;
        pchNanoMessageStart[2] = 0xb5;
        pchNanoMessageStart[3] = 0xda;
        nDefaultPort = 18556;
        nPruneAfterHeight = 1000;
