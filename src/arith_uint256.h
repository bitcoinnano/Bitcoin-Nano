...
#ifndef BTCNANO_ARITH_UINT256_H
#define BTCNANO_ARITH_UINT256_H
...
public:
     ...
     *
     * Btcnano only uses this "compact" format for encoding difficulty targets,
