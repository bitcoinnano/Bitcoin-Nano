 ...
 * thread wrappers.
 */
#ifndef BTCNANO_UTIL_H
#define BTCNANO_UTIL_H
...
extern const char *const BTCNANO_CONF_FILENAME;
extern const char *const BTCNANO_PID_FILENAME;
...
template <typename Callable> void TraceThread(const char *name, Callable func) {
    std::string s = strprintf("btcnano-%s", name);
