...
#ifndef BTCNANO_QT_BTCNANOAMOUNTFIELD_H
#define BTCNANO_QT_BTCNANOAMOUNTFIELD_H
...
/** Widget for entering btcnano amounts.
  */
class BtcnanoAmountField : public QWidget {
    Q_OBJECT

    // ugly hack: for some unknown reason CAmount (instead of qint64) does not
    // work here as expected
    // discussion: https://github.com/btcnano/btcnano/pull/5117
    Q_PROPERTY(
        qint64 value READ value WRITE setValue NOTIFY valueChanged USER true)

public:
    explicit BtcnanoAmountField(QWidget *parent = 0);
...
#endif // BTCNANO_QT_BTCNANOAMOUNTFIELD_H
