...
#ifndef BTCNANO_VALIDATION_H
#define BTCNANO_VALIDATION_H
...
static const size_t HEADER_SIZE = 140;

#define equihash_parameters_acceptable(N, K) \
	((HEADER_SIZE + equihash_solution_size(N, K))*MAX_HEADERS_RESULTS < \
