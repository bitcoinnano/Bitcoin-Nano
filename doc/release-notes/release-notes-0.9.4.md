Btcnano Core version 0.9.4 is now available from:

  https://btcnano.org/bin/0.9.4/
...
this update is incompatible with the Btcnano system and could lead to consensus
forks.

Btcnano Core released binaries from https://btcnano.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~btcnano/+archive/ubuntu/btcnano
- A third-party or self-compiled Btcnano Core

upgrade to Btcnano Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
