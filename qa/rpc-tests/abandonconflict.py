...
class AbandonConflictTest(BtcnanoTestFramework):
    ...
    def run_test(self):
        ...
        inputs = []
        # spend 10btn outputs from txA and txB
        ...
        # Identify the 14.99998btn output
        ...
        # Verify that B and C's 10 BTN outputs are available for spending again
        ...
        # Invalidate the block with the double spend and B's 10 BTN output should no longer be available
