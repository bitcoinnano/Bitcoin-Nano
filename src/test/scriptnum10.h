...
#ifndef BTCNANO_TEST_SCRIPTNUM10_H
#define BTCNANO_TEST_SCRIPTNUM10_H
...
class CScriptNum10 {
    /**
     * The ScriptNum implementation from Btcnano Core 0.10.0, for
     * cross-comparison.
     */
public:
