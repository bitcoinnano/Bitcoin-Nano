Btcnano version 0.7.2 is now available from:
  http://sourceforge.net/projects/btcnano/files/Btcnano/btcnano-0.7.2
...
* Fix use-after-free problems in initialization and shutdown, the latter of
  which caused Btcnano-Qt to crash on Windows when exiting.
