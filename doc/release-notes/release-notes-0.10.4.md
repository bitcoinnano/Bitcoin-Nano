Btcnano Core version 0.10.4 is now available from:

  <https://btcnano.org/bin/btcnano-core-0.10.4/>
...
- #6953 `43c2789` Split btcnano-tx into its own package
- #6953 `dfe0d4d` Include btcnano-tx binary on Debian/Ubuntu
