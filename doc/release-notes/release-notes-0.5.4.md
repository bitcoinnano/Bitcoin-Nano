Btcnano version 0.5.4 is now available for download at:
http://sourceforge.net/projects/btcnano/files/Btcnano/btcnano-0.5.4/
...
http://gitorious.org/btcnano/btcnanod-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Btcnano-Qt notifications under Growl 1.3.
Increase required age of Btcnano-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxBtcnano properly when installing Btcnano-Qt over it. (Windows)
