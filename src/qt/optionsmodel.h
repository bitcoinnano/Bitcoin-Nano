...
#ifndef BTCNANO_QT_OPTIONSMODEL_H
#define BTCNANO_QT_OPTIONSMODEL_H
...
/** Interface from Qt to configuration data structure for Btcnano client.
...
#endif // BTCNANO_QT_OPTIONSMODEL_H
