...
unlocked to sign the Btcnano-Qt.app bundle.
...
allowing somebody to distribute a Btcnano-Qt.app or btcnano-qt-setup.exe with a valid
...
that the btcnano-qt.exe file inside the installer had not been tampered with.
