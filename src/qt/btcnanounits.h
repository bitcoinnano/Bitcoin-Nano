...
#ifndef BTCNANO_QT_BTCNANOUNITS_H
#define BTCNANO_QT_BTCNANOUNITS_H
...
/**
 * Btcnano unit definitions. Encapsulates parsing and formatting and serves as
 * list model for drop-down selection boxes.
 */
class BtcnanoUnits : public QAbstractListModel {
    Q_OBJECT

public:
    explicit BtcnanoUnits(QObject *parent);

    /**
     * Btcnano units (Btcnano Cash unit work the same as Bitoin).
     * @note Source: https://en.btcnano.it/wiki/Units.
...
typedef BtcnanoUnits::Unit BtcnanoUnit;

#endif // BTCNANO_QT_BTCNANOUNITS_H
