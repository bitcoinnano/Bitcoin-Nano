Btcnano Core version 0.9.2.1 is now available from:

  https://btcnano.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 BTN to 0.01 BTN
...
- Fix "Start btcnano on system login"
