 ...
 * for both btcnanod and btcnano-core, to make it harder for attackers to
 * target servers or GUI users specifically.
 */
const std::string CLIENT_NAME("Btcnano Nano");
 ...
 * (https://github.com/btcnano/bips/blob/master/bip-0014.mediawiki)
 */
