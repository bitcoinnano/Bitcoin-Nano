Btcnano-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/btcnano/files/Btcnano/btcnano-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Btcnano
...
New/changed settings (command-line or btcnano.conf file)
--------------------------------------------------------
