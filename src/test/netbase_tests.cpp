...
BOOST_AUTO_TEST_CASE(netbase_splithost) {
    BOOST_CHECK(TestSplitHost("www.btcnano.org", "www.btcnano.org", -1));
    BOOST_CHECK(TestSplitHost("[www.btcnano.org]", "www.btcnano.org", -1));
    BOOST_CHECK(TestSplitHost("www.btcnano.org:80", "www.btcnano.org", 80));
    BOOST_CHECK(TestSplitHost("[www.btcnano.org]:80", "www.btcnano.org", 80));
    ...
    BOOST_CHECK(
        TestSplitHost("[::ffff:127.0.0.1]:9556", "::ffff:127.0.0.1", 9556));
