...
static const std::string mainnet_seeds[] = {
    "seed.btcnano.org", "seed.btcnano1.org", 
    "seed.btcnano2.org", "seed.btcnano3.org", ""};
static const std::string testnet_seeds[] = {
    "testnet-seed.btcnano.org", "testnet-seed.btcnano1.org", 
    "testnet-seed.btcnano2.org", "testnet-seed.btcnano3.org", ""};
static const std::string *seeds = mainnet_seeds;

extern "C" void *ThreadSeeder(void *) {
    if (!fTestNet) {
        db.Add(CService("kjy2eqzk4zwi5zd3.onion", 9556), true);
    }
    do {
