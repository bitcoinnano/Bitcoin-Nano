...
TransactionTableModel::TransactionTableModel(
    ...
    columns << QString() << QString() << tr("Date") << tr("Type") << tr("Label")
            << BtcnanoUnits::getAmountColumnTitle(
...
void TransactionTableModel::updateAmountColumnTitle() {
    columns[Amount] = BtcnanoUnits::getAmountColumnTitle(
        walletModel->getOptionsModel()->getDisplayUnit());
...
QString TransactionTableModel::formatTxAmount(
    ...
    BtcnanoUnits::SeparatorStyle separators) const {
    QString str =
        BtcnanoUnits::format(walletModel->getOptionsModel()->getDisplayUnit(),
...
QVariant TransactionTableModel::data(const QModelIndex &index, int role) const {
    ...
    switch (role) {
        ...
        case TxPlainTextRole: {
            ...
            details.append(
                formatTxAmount(rec, false, BtcnanoUnits::separatorNever));
            return details;
        }
        case ConfirmedRole:
        ...
        case FormattedAmountRole:
            ...
            return formatTxAmount(rec, false, BtcnanoUnits::separatorNever);
        case StatusRole:
