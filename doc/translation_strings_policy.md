...
This document provides guidelines for internationalization of the Btcnano Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `btcnano_en.ts` remains unchanged.
