...
#ifndef BTCNANO_SCRIPT_SCRIPT_H
#define BTCNANO_SCRIPT_SCRIPT_H
...
public:
    ...
    /**
     * Pre-version-0.6, Btcnano always counted CHECKMULTISIGs as 20 sigops. With
