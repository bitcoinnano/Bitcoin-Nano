...
/* Window elements init */
    ...
    ui->btcnanoAtStartup->setToolTip(
        ui->btcnanoAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->btcnanoAtStartup->setText(
        ui->btcnanoAtStartup->text().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new BtcnanoUnits(this));
...
void OptionsDialog::setMapper() {
    /* Main */
    mapper->addMapping(ui->btcnanoAtStartup, OptionsModel::StartAtStartup);
