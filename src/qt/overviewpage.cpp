...
public:
    TxViewDelegate(const PlatformStyle *_platformStyle,
        ...
        : QAbstractItemDelegate(parent), unit(BtcnanoUnits::BTN),
    ...
    inline void paint(QPainter *painter, const QStyleOptionViewItem &option,
        ...
        painter->setPen(foreground);
        QString amountText = BtcnanoUnits::formatWithUnit(
            unit, amount, true, BtcnanoUnits::separatorAlways);
        if (!confirmed) {
...
void OverviewPage::setBalance(const CAmount &balance,
    ...
    ui->labelBalance->setText(BtcnanoUnits::formatWithUnit(
        unit, balance, false, BtcnanoUnits::separatorAlways));
    ui->labelUnconfirmed->setText(BtcnanoUnits::formatWithUnit(
        unit, unconfirmedBalance, false, BtcnanoUnits::separatorAlways));
    ui->labelImmature->setText(BtcnanoUnits::formatWithUnit(
        unit, immatureBalance, false, BtcnanoUnits::separatorAlways));
    ui->labelTotal->setText(BtcnanoUnits::formatWithUnit(
        unit, balance + unconfirmedBalance + immatureBalance, false,
        BtcnanoUnits::separatorAlways));
    ui->labelWatchAvailable->setText(BtcnanoUnits::formatWithUnit(
        unit, watchOnlyBalance, false, BtcnanoUnits::separatorAlways));
    ui->labelWatchPending->setText(BtcnanoUnits::formatWithUnit(
        unit, watchUnconfBalance, false, BtcnanoUnits::separatorAlways));
    ui->labelWatchImmature->setText(BtcnanoUnits::formatWithUnit(
        unit, watchImmatureBalance, false, BtcnanoUnits::separatorAlways));
    ui->labelWatchTotal->setText(BtcnanoUnits::formatWithUnit(
        unit, watchOnlyBalance + watchUnconfBalance + watchImmatureBalance,
        false, BtcnanoUnits::separatorAlways));
