...
#ifndef BTCNANO_CLIENTVERSION_H
#define BTCNANO_CLIENTVERSION_H
...
//! These need to be macros, as clientversion.cpp's and btcnano*-res.rc's voodoo
//! requires it
...
/**
 * btcnanod-res.rc includes this file, but it cannot cope with real c++ code.
