Btcnano Nano version 0.15.1 is now available from:

  <https://download.btcnano.org/0.15.1/>
...
- Add seeder to Btcnano Nano repository. From Btcnano Seeder by Pieter Wiulle.
