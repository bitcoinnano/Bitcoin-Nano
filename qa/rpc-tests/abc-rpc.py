...
# Exercise the Btcnano Nano RPC calls.
...
class ABC_RPC_Test (BtcnanoTestFramework):
    ...
    def test_excessiveblock(self):
        ...
        self.check_subversion("/Btcnano Nano:.*\(EB2\.0; .*\)/")
        ...
        # Check for EB correctness in the subver string
        self.check_subversion("/Btcnano Nano:.*\(EB13\.0; .*\)/")
