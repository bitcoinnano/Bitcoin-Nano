...
#ifndef BTCNANO_INIT_H
#define BTCNANO_INIT_H
...
/** Initialize btcnano core: Basic context setup.
...
/**
 * Btcnano core main initialization.
...
enum HelpMessageMode { HMM_BTCNANOD, HMM_BTCNANO_QT };
