Btcnano Core version 0.13.2 is now available from:

  <https://btcnano.org/bin/btcnano-core-0.13.2/>
...
- #8908 `4a974b2` Update btcnano-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow btcnano-tx to create v2 transactions (btndrak)
