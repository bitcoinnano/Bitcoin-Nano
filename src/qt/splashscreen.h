...
#ifndef BTCNANO_QT_SPLASHSCREEN_H
#define BTCNANO_QT_SPLASHSCREEN_H
 ...
 *
 * @note this is intentionally not a QSplashScreen. Btcnano Core initialization
...
#endif // BTCNANO_QT_SPLASHSCREEN_H
