...
# TestNode: A peer we use to send messages to btcnanod, and store responses.
...
class CompactBlocksTest(BtcnanoTestFramework):
    ...
    # This test actually causes btcnanod to (reasonably!) disconnect us, so do
    # this last.
    ...
    # Test that btcnanod requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for btcnanod to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # btcnanod will not send blocktxn responses for blocks whose height is
