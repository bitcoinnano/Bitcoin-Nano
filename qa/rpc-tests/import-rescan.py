...
import RPC call and node 0 sends BTN to it. Then other nodes import the
...
In the second part of the test, node 0 sends more BTN to each address, and the
...
class ImportRescanTest(BtcnanoTestFramework):
