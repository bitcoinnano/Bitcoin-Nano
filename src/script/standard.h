...
#ifndef BTCNANO_SCRIPT_STANDARD_H
#define BTCNANO_SCRIPT_STANDARD_H
 ...
 *  A CTxDestination is the internal data type encoded in a btcnano address
 */
...
#endif // BTCNANO_SCRIPT_STANDARD_H
