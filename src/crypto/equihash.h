...
#ifndef BTCNANO_EQUIHASH_H
#define BTCNANO_EQUIHASH_H
...
{
    if (n == 96 && k == 3) {
        return Eh96_3.BasicSolve(base_state, validBlock);
    } else if (n == 200 && k == 9) {
        return Eh200_9.BasicSolve(base_state, validBlock);
    } else if (n == 96 && k == 5) {
        return Eh96_5.BasicSolve(base_state, validBlock);
    } else if (n == 48 && k == 5) {
        return Eh48_5.BasicSolve(base_state, validBlock);
    } else if (n == 144 && k == 5) {
        return Eh144_5.BasicSolve(base_state, validBlock);	
    } else {
        throw std::invalid_argument("Unsupported Equihash parameters");
    }
}
...
{
    if (n == 96 && k == 3) {
        return Eh96_3.OptimisedSolve(base_state, validBlock);
    } else if (n == 200 && k == 9) {
        return Eh200_9.OptimisedSolve(base_state, validBlock);
    } else if (n == 96 && k == 5) {
        return Eh96_5.OptimisedSolve(base_state, validBlock);
    } else if (n == 48 && k == 5) {
        return Eh48_5.OptimisedSolve(base_state, validBlock);
    } else if (n == 144 && k == 5) {
        return Eh144_5.OptimisedSolve(base_state, validBlock);
    } else {
        throw std::invalid_argument("Unsupported Equihash parameters");
    }
}
