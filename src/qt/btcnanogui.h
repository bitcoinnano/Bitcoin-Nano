...
#ifndef BTCNANO_QT_BTCNANOGUI_H
#define BTCNANO_QT_BTCNANOGUI_H
...
public:
    ...
    explicit BtcnanoGUI(const PlatformStyle *platformStyle,
     ...
     * The wallet model represents a btcnano wallet, and offers access to the
